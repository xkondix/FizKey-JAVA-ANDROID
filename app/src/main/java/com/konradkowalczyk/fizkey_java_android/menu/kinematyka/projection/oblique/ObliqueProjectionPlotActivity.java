...
public class ObliqueProjectionPlotActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Fragment fragment = new PlotFragment(obliqueCalculations.getyPostions(),obliqueCalculations.getTimes()
    ...
    private void setCalculations()
    {
        ...
        calculations.add(obliqueCalculations.getyPostions());
        calculations.add(obliqueCalculations.getxPositions());
